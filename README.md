...
<a href="https://www.hackingwithswift.com/100/swiftui/">100 Days of SwiftUI</a> is a hands-on introduction to Swift, SwiftUI, and iOS development. I picked this course, not to get a job, but to learn how to make information work for me, at a time when poor health and healthcare were making work a non-option. Going into it, I decided to ignore interface design and focus on data, and over time, developed a deep interest in data structures, algorithms, and geometry -- the structure, behavior, and shape of information. Thank you to the author of the course, <a href="https://github.com/twostraws">Paul Hudson</a>, for making that happen. 
